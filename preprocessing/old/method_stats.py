...
grouped = df_clean.groupby(["Operation", "Method"])
...
avg_cosine_sim.to_csv("avg_cosine_similarity_per_method_pair.csv", index=False)

print("Done! Averages written to avg_cosine_similarity_per_method_pair.csv.")
